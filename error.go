...
var (
	...
	ErrMValIncInvalid         error = errors.New("M val inc invalid")
	...
	ErrIndexTextParam         error = errors.New("EnsureIndexWithTag: text index params error")
	...
	ErrTransLockWholeTable    error = errors.New("trans lock whole table")
	ErrTransLevelUnknown      error = errors.New("trans level unknown")
	ErrMUndefined             error = errors.New("query m undefined")
)
